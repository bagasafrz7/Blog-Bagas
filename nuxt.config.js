        ...
        vueI18n: {
          ...
          messages: {
            en: {
              ...
              description_estate_management: `Creating a property management web dashboard from start to release. This website was built using TypeScript with Next JS as the framework, and Chakra UI as the library for application styles.`,
            ...
            id: {
              ...
              description_estate_management: `Membuat web dashboard manajemen properti dari awal hinggal rilis. Web ini dibangun menggunakan TypeScript dengan Next JS sebagai kerangka kerja, dan Chakra UI sebagai perpustakaan untuk gaya aplikasinya.`,
